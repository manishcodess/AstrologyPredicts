...
//form me ek functionality hoti h ki agar hum submit 
    const Name = document.getElementById('name').value; //string deta h
...
//get 0 to 29 then 0 to...
    indexx = (Name.length * SurName.length * Year)%30; 
    const fifth_message = recommendations[indexx];
